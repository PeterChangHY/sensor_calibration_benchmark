#!/usr/bin/env python
""" thie module contains method to project 3D points to image plane"""
import numpy as np
import cv2
import pypcd
import calib
...
if __name__ == '__main__':
    ...
    parser.add_argument("--lidar_calib", default='lidar.yml', type=str,
                        help="path to lidar calibration file")
    ...
    parser.add_argument("--output", default="project_points.png",
                        type=str, help="output image file name")
